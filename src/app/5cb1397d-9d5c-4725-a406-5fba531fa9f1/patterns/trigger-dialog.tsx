...
import {
    ...
    DialogHeader,
    DialogTitle,
} from "@/app/5cb1397d-9d5c-4725-a406-5fba531fa9f1/components/dialog";
...
import { Condition as ConditionPreview, ConditionProps as ConditionPreviewProps } from "@/app/5cb1397d-9d5c-4725-a406-5fba531fa9f1/components/conditions";
                            ...
                            <div className="items-center flex gap-2">
                                ...
                                <Select>
                                    ...
                                    <SelectContent className="border-neutral-200">
                                        ...
                                        {Array.from(new Set(exampleSQLTriggers.map(t => t.category).filter((c): c is string => !!c))).map((category) => (
